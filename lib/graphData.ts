// Mock data for Case #101 — Kidnapping & Extortion
// TODO: replace with a real fetch() call to the backend once the API is ready.
// Shape is intentionally close to what the backend will likely return
// (nodes with an entity "type", edges with a relationship "label" + confidence).
